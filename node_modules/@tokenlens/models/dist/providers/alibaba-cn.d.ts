export declare const alibaba_cnModels: {
    readonly id: "alibaba-cn";
    readonly name: "Alibaba (China)";
    readonly api: "https://dashscope.aliyuncs.com/compatible-mode/v1";
...
//# sourceMappingURL=alibaba-cn.d.ts.map