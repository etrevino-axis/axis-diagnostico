...
import { getDimensionTierColor, getDimensionTierLabel, type ScoreResult, type Tier } from "@/lib/diagnostico";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-heading mt-6 text-[28px] leading-tight text-[var(--color-ink)] sm:text-[34px]">
          {tier.title}
        </h2>
              ...
              <div className="mt-2 flex gap-1.5">
                {[0, 1, 2].map((i) => (
                  <div
                    ...
                    style={{
                      backgroundColor: i < points ? "var(--color-gold)" : "rgba(17,17,17,0.08)",
                    }}
                  />
                ))}
              </div>
      ...
      {strongestInsight && (
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.14em]" style={{ color: "#8A6A1F" }}>
