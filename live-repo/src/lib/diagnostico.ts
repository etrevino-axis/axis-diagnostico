/**
 * Motor de reglas del Diagnóstico Financiero de Axis Consultores — v3.
 *
 * Preguntas diseñadas por Eric — no se reescriben, solo se ajusta
 * ligeramente la extensión de algunas opciones para escaneo en móvil.
 * Voz formal ("usted"), consistente con el copy de las preguntas.
 *
 * Cambio de embudo vs v2: se retiran la pregunta de tipo de contribuyente
 * y el calificador de facturación — 6 pasos en vez de 8. Menos fricción,
 * más finalizaciones hacia Calendly, que es exactamente el objetivo de
 * esta revisión.
 *
...
export const QUESTIONS: DiagnosticoQuestion[] = [
  {
    ...
    question: "¿Qué tan fácil sería obtener hoy una respuesta confiable sobre su situación financiera?",
    helper: "Ingresos, gastos, cuánto ganó realmente, o simplemente tener su contabilidad al día.",
    options: [
  ...
  },
  {
    ...
    helper: "Gastos, costos, pagos e inversiones — y cuáles afectan su rentabilidad.",
    options: [
      { id: "exacto", label: "Sé exactamente en qué se está utilizando", points: 3 },
      { id: "principales", label: "Conozco mis principales gastos, pero no tengo una visión completa", points: 2 },
      { id: "aproximada", label: "Tengo una idea, aunque no lo monitoreo regularmente", points: 1 },
  ...
  },
  {
    ...
    helper: "Declaraciones, pagos, facturación y demás obligaciones que correspondan a su actividad.",
    options: [
  ...
  },
  {
    ...
    question: "¿Qué tan seguro está de que su situación fiscal está estructurada de la manera más eficiente posible?",
    helper: "Deducciones, gastos, régimen fiscal, inversiones y otras alternativas que podrían aplicar.",
    options: [
  ...
  },
  {
    ...
    helper: "Cuánto facturar, cuánto puede gastar, cuándo contratar o invertir.",
    options: [
      ...
      { id: "conforme_se_presenta", label: "No lo sé: normalmente decido conforme se presentan las situaciones", points: 0 },
    ],
  },
  {
    ...
    question: "Si mañana necesitara demostrar que su situación está en orden, ¿qué tan preparado estaría?",
    helper: "Una revisión del SAT, una solicitud de crédito, un socio, una auditoría.",
    options: [
      { id: "documentacion_lista", label: "Totalmente preparado: tengo información y documentación actualizada", points: 3 },
      ...
      { id: "no_se_que_presentar", label: "No estoy preparado: no sé exactamente qué necesitaría presentar", points: 0 },
    ],
  },
];
...
// Escala monocromática — regla del UI Kit: sin colores adicionales sin
// función clara. La severidad se comunica con la intensidad del dorado
// hacia el gris, no con un semáforo multicolor.
const DIMENSION_TIER_COLORS = ["#8A5A2A", "#B08A3E", "#0C2156", "#0C2156"];
